...
//    Media
    Route::post('/media/upload-drive', ['as' => 'upload_drive', 'uses' => 'MediaController@uploadDrive']);
    Route::post('/media/get-video-info-by-link', ['as' => 'get_video_info', 'uses' => 'MediaController@getVideoInfoByLink']);
    Route::post('/media/add-video', ['as' => 'add_media_video', 'uses' => 'MediaController@addVideo']);
});
...
//    Socialite
        ...
        Route::get('/login-google', ['as' => 'login_google', 'uses' => 'AuthController@redirectGoogle']);
        Route::get('/login-google/callback', ['as' => 'login_google_cb', 'uses' => 'AuthController@handleGoogle']);
